...
function Framework.Client.SetupPlayerLoginListeners()
  if Config.Framework == "QBCore" then
    RegisterNetEvent("QBCore:Client:OnPlayerLoaded", function()
      ...
      if playerData then
        Framework.CachedPlayerData.hunger = playerData.metadata?.hunger
        Framework.CachedPlayerData.thirst = playerData.metadata?.thirst
      end
    end)
...
function Framework.Client.CreateEventListeners()
  ...
  Framework.CachedPlayerData.hunger = state?.hunger or nil
  Framework.CachedPlayerData.thirst = state?.thirst or nil
  Framework.CachedPlayerData.stress = state?.stress or nil
  ...
  if Config.Framework == "Qbox" then
    ...
    if playerState.hunger then Framework.CachedPlayerData.hunger = playerState.hunger end
    if playerState.thirst then Framework.CachedPlayerData.thirst = playerState.thirst end
